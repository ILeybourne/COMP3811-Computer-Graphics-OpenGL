...
QT_MOC_LITERAL(5, 48, 11), // "resetCamera"
QT_MOC_LITERAL(6, 60, 17), // "changeTerrainSeed"
QT_MOC_LITERAL(7, 78, 4) // "seed"

    },
    "SceneWidget\0getFrameRate\0\0changeScreenTexture\0"
    "i\0resetCamera\0changeTerrainSeed\0seed"
};
...
void SceneWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->changeTerrainSeed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
